...
struct core_inner core_new(void *context_ptr) {
    ...
    return {
        ...
        .interfaces =
            {
                {
                    .in_payload = &core->interfaces_0_sink_payload,
                    .in_valid = (bool *)&core->interfaces_0_sink_valid,
                    .in_ready = (bool *)&core->interfaces_0_sink_ready,
                    .out_payload = &core->interfaces_0_source_payload,
                    .out_valid = (bool *)&core->interfaces_0_source_valid,
                    .out_ready = (bool *)&core->interfaces_0_source_ready,
                ...
                {
                    .in_payload = &core->interfaces_1_sink_payload,
                    .in_valid = (bool *)&core->interfaces_1_sink_valid,
                    .in_ready = (bool *)&core->interfaces_1_sink_ready,
                    .out_payload = &core->interfaces_1_source_payload,
                    .out_valid = (bool *)&core->interfaces_1_source_valid,
                    .out_ready = (bool *)&core->interfaces_1_source_ready,
                ...
                {
                    .in_payload = &core->interfaces_2_sink_payload,
                    .in_valid = (bool *)&core->interfaces_2_sink_valid,
                    .in_ready = (bool *)&core->interfaces_2_sink_ready,
                    .out_payload = &core->interfaces_2_source_payload,
                    .out_valid = (bool *)&core->interfaces_2_source_valid,
                    .out_ready = (bool *)&core->interfaces_2_source_ready,
                ...
                {
                    .in_payload = &core->interfaces_3_sink_payload,
                    .in_valid = (bool *)&core->interfaces_3_sink_valid,
                    .in_ready = (bool *)&core->interfaces_3_sink_ready,
                    .out_payload = &core->interfaces_3_source_payload,
                    .out_valid = (bool *)&core->interfaces_3_source_valid,
                    .out_ready = (bool *)&core->interfaces_3_source_ready,
